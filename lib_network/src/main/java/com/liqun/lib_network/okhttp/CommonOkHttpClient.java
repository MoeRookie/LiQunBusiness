package com.liqun.lib_network.okhttp;

import com.liqun.lib_network.okhttp.listener.DisposeDataHandle;
import com.liqun.lib_network.okhttp.response.CommonFileCallback;
import com.liqun.lib_network.okhttp.response.CommonJsonCallback;
...
public class CommonOkHttpClient {
    ...
    static {
        ...
        clientBuilder.followRedirects(true); // 重定向
        mOkHttpClient = clientBuilder.build();
    }

    /**
     * 通过构造好的Request, Callback去发送请求(Get请求)
     * @param handle
     * @return
     */
